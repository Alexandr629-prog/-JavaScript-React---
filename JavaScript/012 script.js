...
'Use strict';
 const numbetFilm = + prompt('Сколько фильмов вы уже посмотрели?',  ' ');
...
const appraisalFilm2 = prompt('На сколько оцените его?','');
personalMovieDB.movies[lastFilm]=appraisalFilm;
personalMovieDB.movies[lastFilm2]=appraisalFilm2;
