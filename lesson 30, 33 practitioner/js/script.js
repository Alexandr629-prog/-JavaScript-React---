...
document.addEventListener('DOMContentLoaded', () => {//script начнет подгружатья после загрузки dom-дерева
    ...
    const adv = document.querySelectorAll('.promo__adv img'),//реклама
        poster = document.querySelector('.promo__bg'),// фон
        genre = poster.querySelector('.promo__genre'),//жанр
        movieList = document.querySelector('.promo__interactive-list'),// все фильмы
